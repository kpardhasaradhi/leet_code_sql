...
-- The first part retrieves the most recent price before or on the target date.
-- The second part ensures that products without any price record before that date get a default price of 10.
-- The union combines both sets into the final result.
